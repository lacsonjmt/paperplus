...
type RouteParams = { unit: string; bed: string; page: string; subpage: string }
type RouteId = '/(app)/[unit]/[bed]/[page]/[subpage]';
...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.AwaitedProperties<Awaited<ReturnType<typeof import('../../../../../../../../../src/routes/(app)/[unit]/[bed]/[page]/[subpage]/+page.server.js').load>>>>>>;
