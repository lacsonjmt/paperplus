...
type RouteParams = { unit: string; bed: string; page: string }
type RouteId = '/(app)/[unit]/[bed]/[page]';
...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.AwaitedProperties<Awaited<ReturnType<typeof import('../../../../../../../../src/routes/(app)/[unit]/[bed]/[page]/+page.server.js').load>>>>>>;
