...
type RouteParams = { unit: string }
type RouteId = '/(app)/[unit]';
...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.AwaitedProperties<Awaited<ReturnType<typeof import('../../../../../../src/routes/(app)/[unit]/+page.server.js').load>>>>>>;
