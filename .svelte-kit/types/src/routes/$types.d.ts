...
type LayoutRouteId = RouteId | "/(app)" | "/(app)/archived-episodes/[ptEncounterID]/[unitID]/flowsheet" | "/(app)/[unit]" | "/(app)/[unit]/[bed]" | "/(app)/[unit]/[bed]/[page]" | "/(app)/[unit]/[bed]/[page]/[subpage]" | "/admin/(users)" | "/admin/client-pcs" | "/admin/patient-accesses" | "/change-password" | "/login" | "/logout" | "/print" | "/print/billing" | null
type LayoutParams = RouteParams & { ptEncounterID?: string,unitID?: string,unit?: string,bed?: string,page?: string,subpage?: string }
