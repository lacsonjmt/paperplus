...
declare module '$env/static/private' {
	...
	export const FLOWSHEET_INTERVAL_MINUTES: string;
	export const FLOWSHEET_AUTOCHART_MINUTES: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		FLOWSHEET_INTERVAL_MINUTES: string;
		FLOWSHEET_AUTOCHART_MINUTES: string;
